			...
			<ul>
				<li>
					...
					<div class="poll_content">
						<h4>
							<a href="<?php echo base_url();?>index.php/zone/show_poll/<?php echo $this->uri->segment(3);?>/<?php echo $row->poll_question;?>">
						...
						<div class="poll_options">
							...
							?>
 							...
 							<p>
								...
								<a href="<?php echo base_url();?>index.php/zone/delete_poll/<?php echo $this->uri->segment(3);?>/<?php echo $row->poll_question;?>">
									<img src="<?php echo base_url();?>system/application/views/image/icon_del.gif" Title="删除" style="margin-bottom:-4px;">
								</a>
						 	</p>
						</div>
					...
					<div class="poll_status">
						<a class="poll_joins pj_2" href="<?php echo base_url();?>index.php/zone/show_poll/<?php echo $this->uri->segment(3);?>/<?php echo $row->poll_question;?>">
							<span>
								<?php echo $row->poll_total_vote;?>
							</span>人参与
						</a> 
						<a class="go2_poll" href="<?php echo base_url();?>index.php/zone/show_poll/<?php echo $this->uri->segment(3);?>/<?php echo $row->poll_question;?>">
							去投票
						</a>
					</div>
				</li>
