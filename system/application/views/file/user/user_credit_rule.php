...
<div id="mainarea">
	...
	<div class="l_status c_form">
		<a href="<?php echo base_url();?>index.php/zone/user_credit/<?php echo $this->uri->segment(3);?>">我的积分</a><span class="pipe">|</span>
		<a class="active" href="<?php echo base_url();?>index.php/zone/user_credit_rule/<?php echo $this->uri->segment(3);?>">用户组规则</a><span class="pipe">|</span>
	</div>
	...
	<div class="c_form">
		<table cellspacing="0" cellpadding="0" class="listtable">
			...
			<tr>
				...
				<td>1000 ~ 999999999</td>
			</tr>
			<tr>
				<th><span>中级会员</span></th>
				<td>100 ~ 999</td>
			</tr>
			<tr>
