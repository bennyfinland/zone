...
<div id="mainarea">
	...
	<div class="l_status c_form">
		<a class="active" href="<?php echo base_url();?>index.php/zone/user_info/<?php echo $this->uri->segment(3);?>">基本资料</a>
	...
	<?php echo form_open("zone/user_info_insert"); ?>
		<table cellspacing="0" cellpadding="0" class="formtable">
			...
			<tr>
				...
				<td>
					<input type="text" class="t_input" value="" name="nick_name" id="nick_name">
				</td>
			</tr>
			<tr>
				<th style="width: 10em;">性别:</th>
				<td>
					<label for="sex"><input type="radio" name="sex" value="男" checked>男</label> 
					<label for="sex"><input type="radio" name="sex" value="女">女</label>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th>生日:</th>
				<td>
					<input type="text" id="datepicker" name="datepicker" value="" class="t_input">
				</td>
			</tr>
			<tr>
