...
<div id="wrap">
	...
	<div class="ye_r_t"><div class="ye_l_t"><div class="ye_r_b"><div class="ye_l_b">
		...
		<p>
			...
			<script>setTimeout("window.location.href ='<?php echo base_url();?>index.php/zone/show_article/<?php echo $user_name;?>/<?php echo $article_title;?>/<?php echo $class_name;?>/<?php echo $friend_name;?>';", 3000);</script>
			<p class="op">
