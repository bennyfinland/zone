...
<div id="wrap">
	...
	<div class="ye_r_t"><div class="ye_l_t"><div class="ye_r_b"><div class="ye_l_b">
		...
		<p>
			...
			<script>setTimeout("window.location.href ='<?php echo base_url();?>index.php/zone/photo/<?php echo $this->uri->segment(3);?>';", 3000);</script>
			<p class="op">
				<?php echo anchor("zone/photo/".$user_name,"页面跳转中..."); ?>
			</p>
