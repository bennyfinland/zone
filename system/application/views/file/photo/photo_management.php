...
<div id="mainarea">
	...
	<div class="tabs_header">
		<ul class="tabs">
			<li class="active">
				<a href="<?php echo base_url();?>index.php/zone/photo/<?php echo $this->uri->segment(3);?>/<?php echo $gruop_name;?>">
					<span>管理相册图片</span>
				</a>
			</li>
			<li>
			    ...
			    <?php if ($i % 5 == 0): ?>
		  	    ...
		  	    <?php endif; ?>			
					<td style="padding-bottom: 20px;">
							<img src="<?php echo base_url();?>uploads/photo/photo/<?php echo $row->photo_name;?>" class="mark"><br>		
							<?php echo '<a href="'.base_url().'index.php/zone/photo_preview/'.$this->uri->segment(3).'/'.$row->photo_name.'/'.$gruop_name.'">' ?>
								<img src="<?php echo base_url();?>system/application/views/image/icon_purview.gif" Title="设为封面">
							</a>
							<?php echo '<a href="'.base_url().'index.php/zone/photo_delete/'.$this->uri->segment(3).'/'.$row->photo_name.'/'.$gruop_name.'">' ?>
