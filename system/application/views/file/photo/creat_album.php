	...
	$("#commentForm").validate({
		...
		rules: {
			 	gruop_name: {
					...
					minlength: 2,
			    	remote: {
						url: "<?php echo base_url();?>index.php/zone/check_gruop_name/<?php echo $this->uri->segment(3);?>",
						type: "post",
						data: {
							gruop_name: function(){
								return $("#gruop_name").val();
							}
						}
					}	
			     }	
...
<div id="mainarea">
	...
	<div class="tabs_header">
		<ul class="tabs">
			<li class="active">
				<a href="<?php echo base_url();?>index.php/zone/creat_album/<?php echo $this->uri->segment(3);?>">
					<span>新建相册</span>
				</a>
			</li>
			<li>
	...
	<div class="c_form">
		...
		<?php 
			...
			echo form_open("zone/creat_album_gruop",$attributes);
		?>
				...
				<tr><td>
					<table width="100%">
						<tbody><tr>
							<th width="60">相册名</th>
							<td>
								<input type="text" value="我的相册" name="gruop_name" id="gruop_name" size="20" class="t_input">
								<input type="hidden" value="<?php echo $this->uri->segment(3);?>" name="gruop_username">
							</td>
						</tr></tbody>
					</table>
				</td></tr>
