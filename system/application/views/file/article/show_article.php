...
<?php foreach($article_info->result() as $row):?>
	...
	<div style="padding: 0pt 0pt 10px;">
		<div style="text-align: right; padding-top: 10px; margin-right:2%;">
			<?php echo '<a href="'.base_url().'index.php/zone/article_edit/'.$this->uri->segment(3).'/'.$row->article_title.'/'.$row->class_name.'">' ?> 
				<img src="<?php echo base_url();?>system/application/views/image/mod_album.gif" Title="修改">
			</a>
			<span class="pipe">|</span>
			<?php echo '<a href="'.base_url().'index.php/zone/article_delete/'.$this->uri->segment(3).'/'.$row->article_title.'/'.$row->class_name.'">' ?> 
	...
	<div id="content">
		<div id="click_div">
			<div class="digc">
				...
				<!--rater star-->
					<div id="tab-Testing">
						<?php echo form_open("zone/article_rating"); ?>					
							...
							<input type="hidden" name="friend_name" value="<?php if($this->uri->segment(6)==""){echo "";}if($this->uri->segment(6)!=""){echo $this->uri->segment(6);}?>">
		...
		<?php foreach($article->result() as $row):?>
			<ul class="news_list">
				<li style="height: auto;">
					...
					<?php echo '<a href="'.base_url().'index.php/zone/show_article/'.$this->uri->segment(3).'/'.$row->article_title.'/'.$row->class_name.'/'.$row->article_username.'">' ?> 
						<?php echo $row->article_title;?>
					</a>
				</li>
			</ul>
